import { COMPANIES, Company } from "@/src/app/data/keybidData";
...
export function finalizeWinningBid(
  ...
  const newState: KeyState = {
    ...
    currentHolder: {
      ...
      iconUrl:
        bidData.iconUrl ||
        `https://www.google.com/s2/favicons?domain=${bidData.website ? new URL(bidData.website.startsWith("http") ? bidData.website : `https://${bidData.website}`).hostname : "keybid.lol"
        }&sz=128`,
