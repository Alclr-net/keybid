        ...
        <>
            ...
            <header className="w-[95%] max-w-6xl mx-auto flex justify-between items-stretch sticky top-4 sm:top-5 z-50 bg-white border border-neutral-200 dark:border-neutral-800/80 backdrop-blur-2xl rounded-2xl shadow-xs">
                ...
                <div className=" flex items-center justify-center gap-2 sm:gap-3">
                    {/* <div className="hidden sm:flex items-center gap-1 text-sm text-zinc-600 dark:text-zinc-500">
                        <span className={cn("text-violet-400")}>${"5"}</span>
                        <span className={cn("text-zinc-600 dark:text-neutral-500")}>in pool</span>
                    </div> */}
                    <Pannel>
                        <div className={cn("px-2 py-1 flex items-center gap-2")}>
                            ...
                            transition-duration-300">3 keys Calimed</span>
