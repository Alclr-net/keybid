...
function AppleMusicIcon({ className, ...props }: { className?: string, props?: SVGProps<SVGSVGElement> }): React.ReactNode {
    return (
        <svg className={cn("w-15 h-15", className)} xmlSpace="preserve" viewBox="0 0 361 361" {...props}>
            <defs>
